...
impl Meta for Es6OctalAndBinaryLiterals {
    ...
    fn subtests(&self) -> Vec<Subtest> {
        vec![
            ...
            }, Subtest { name : "binary literals", exec :
            "return 0b10 === 2 && 0B10 === 2;" }, Subtest { name :
            "octal supported by Number()", exec : "return Number('0o1') === 1;" },
            Subtest { name : "binary supported by Number()", exec :
            "return Number('0b1') === 1;" },
        ]
    }
}
