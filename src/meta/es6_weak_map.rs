...
impl Meta for Es6WeakMap {
    ...
    fn subtests(&self) -> Vec<Subtest> {
        vec![
            ...
            "constructor invokes set", exec :
            "var passed = false;\nvar _set = WeakMap.prototype.set;\n\nWeakMap.prototype.set = function(k, v) {\n  passed = true;\n};\n\nnew WeakMap([ [{ }, 42] ]);\nWeakMap.prototype.set = _set;\n\nreturn passed;",
            }, Subtest { name : "frozen objects as keys", exec :
            "var f = Object.freeze({});\nvar m = new WeakMap;\nm.set(f, 42);\nreturn m.get(f) === 42;",
            }, Subtest { name : "iterator closing", exec :
            "var closed = false;\nvar iter = global.__createIterableObject([1, 2, 3], {\n  'return': function(){ closed = true; return {}; }\n});\ntry {\n  new WeakMap(iter);\n} catch(e){}\nreturn closed;",
            }, Subtest { name : "WeakMap.prototype.set returns this", exec :
            "var weakmap = new WeakMap();\nvar key = {};\nreturn weakmap.set(key, 0) === weakmap;",
            }, Subtest { name : "WeakMap.prototype.delete", exec :
            "return typeof WeakMap.prototype.delete === \"function\";", }, Subtest { name
            : "no WeakMap.prototype.clear method", exec :
            "if (!(\"clear\" in WeakMap.prototype)) {\n  return true;\n}\nvar m = new WeakMap();\nvar key = {};\nm.set(key, 2);\nm.clear();\nreturn m.has(key);",
            }, Subtest { name : ".has, .get and .delete methods accept primitives", exec
            :
            "var m = new WeakMap;\nreturn m.has(1) === false\n  && m.get(1) === void undefined\n  && m.delete(1) === false;",
            }, Subtest { name : "WeakMap.prototype isn't an instance", exec :
