use crate::{
    ...
    features::Es2019SymbolPrototypeDescription,
};
impl Meta for Es2019SymbolPrototypeDescription {
    ...
    fn subtests(&self) -> Vec<Subtest> {
        vec![
            Subtest { name: "basic", exec: "return Symbol('foo').description === 'foo';" },
            Subtest { name: "empty description", exec: "return Symbol('').description === '';" },
            Subtest {
