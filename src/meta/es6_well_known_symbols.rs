...
impl Meta for Es6WellKnownSymbols {
    ...
    fn subtests(&self) -> Vec<Subtest> {
        vec![
            ...
            Subtest { name: "Symbol.iterator, existence", exec: "return \"iterator\" in Symbol;" },
            Subtest {
            ...
            Subtest { name: "Symbol.species, existence", exec: "return \"species\" in Symbol;" },
            Subtest {
