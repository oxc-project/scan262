...
impl Meta for Es5StrictMode {
    ...
    fn subtests(&self) -> Vec<Subtest> {
        vec![
            Subtest { name : "reserved words", exec :
            ...
            }, Subtest { name : "\"this\" is undefined in functions", exec :
            "'use strict';\nreturn this === void undefined && (function(){ return this === void undefined; }).call();",
            }, Subtest { name : "\"this\" is not coerced to object in primitive methods",
            exec :
            ...
            "\"this\" is not coerced to object in primitive accessors", exec :
            ...
            }, Subtest { name : "legacy octal is a SyntaxError", exec :
            "'use strict';\ntry { eval('010');     return false; } catch (err) { if (!(err instanceof SyntaxError)) return false; }\ntry { eval('\"\\\\010\"'); return false; } catch (err) { if (!(err instanceof SyntaxError)) return false; }\nreturn true;",
            }, Subtest { name :
            "assignment to unresolvable identifiers is a ReferenceError", exec :
            "'use strict';\ntry { eval('__i_dont_exist = 1'); } catch (err) { return err instanceof ReferenceError; }",
            }, Subtest { name : "assignment to eval or arguments is a SyntaxError", exec
            :
            ...
            }, Subtest { name : "assignment to non-writable properties is a TypeError",
            exec :
            ...
            }, Subtest { name : "eval or arguments bindings is a SyntaxError", exec :
