use crate::{
    ...
    features::Es6ObjectStaticMethodsAcceptPrimitives,
};
impl Meta for Es6ObjectStaticMethodsAcceptPrimitives {
    ...
    fn subtests(&self) -> Vec<Subtest> {
        vec![
            ...
            Subtest { name: "Object.freeze", exec: "return Object.freeze('a') === 'a';" },
            Subtest {
                name: "Object.preventExtensions",
                exec: "return Object.preventExtensions('a') === 'a';",
            },
            Subtest { name: "Object.isSealed", exec: "return Object.isSealed('a') === true;" },
            Subtest { name: "Object.isFrozen", exec: "return Object.isFrozen('a') === true;" },
            Subtest {
