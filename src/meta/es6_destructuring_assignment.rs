...
impl Meta for Es6DestructuringAssignment {
    ...
    fn subtests(&self) -> Vec<Subtest> {
        vec![
            ...
            }, Subtest { name : "iterable destructuring expression", exec :
            "var a, b, iterable = [1,2];\nreturn ([a, b] = iterable) === iterable;", },
            Subtest { name : "chained iterable destructuring", exec :
            "var a,b,c,d;\n[a,b] = [c,d] = [1,2];\nreturn a === 1 && b === 2 && c === 1 && d === 2;",
            }, Subtest { name : "trailing commas in iterable patterns", exec :
            "var a;\n[a,] = [1];\nreturn a === 1;", }, Subtest { name : "with objects",
            exec :
            ...
            "object destructuring expression", exec :
            "var a, b, obj = { a:1, b:2 };\nreturn ({a,b} = obj) === obj;", }, Subtest {
            name : "parenthesised left-hand-side is a syntax error", exec :
            "var a, b;\n({a,b} = {a:1,b:2});\ntry {\n  eval(\"({a,b}) = {a:3,b:4};\");\n}\ncatch(e) {\n  return a === 1 && b === 2;\n}",
            }, Subtest { name : "chained object destructuring", exec :
            "var a,b,c,d;\n({a,b} = {c,d} = {a:1,b:2,c:3,d:4});\nreturn a === 1 && b === 2 && c === 3 && d === 4;",
            }, Subtest { name : "throws on null and undefined", exec :
