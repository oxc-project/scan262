...
impl Meta for Es6NonStrictFunctionSemantics {
    ...
    fn subtests(&self) -> Vec<Subtest> {
        vec![
            Subtest { name : "hoisted block-level function declaration", exec :
            "// Note: only available outside of strict mode.\nif (!this) return false;\nvar passed = f() === 1;\nfunction f() { return 1; }\n\npassed &= typeof g === 'undefined';\n{ function g() { return 1; } }\npassed &= g() === 1;\n\npassed &= h() === 2;\n{ function h() { return 1; } }\nfunction h() { return 2; }\npassed &= h() === 1;\n\nreturn passed;",
            }, Subtest { name : "labeled function statements", exec :
            "// Note: only available outside of strict mode.\nif (!this) return false;\n\nlabel: function foo() { return 2; }\nreturn foo() === 2;",
            }, Subtest { name : "function statements in if-statement clauses", exec :
