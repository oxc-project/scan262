...
impl Meta for Es6MiscellaneousSubclassables {
    ...
    fn subtests(&self) -> Vec<Subtest> {
        vec![
            Subtest { name : "Boolean is subclassable", exec :
            "class C extends Boolean {}\nvar c = new C(true);\nreturn c instanceof Boolean\n  && c instanceof C\n  && c == true; // eslint-disable-line eqeqeq"
            }, Subtest { name : "Number is subclassable", exec :
            "class C extends Number {}\nvar c = new C(6);\nreturn c instanceof Number\n  && c instanceof C\n  && +c === 6;"
            }, Subtest { name : "String is subclassable", exec :
            "class C extends String {}\nvar c = new C(\"golly\");\nreturn c instanceof String\n  && c instanceof C\n  && c + '' === \"golly\"\n  && c[0] === \"g\"\n  && c.length === 5;"
            }, Subtest { name : "Error is subclassable", exec :
            "class C extends Error {}\nvar c = new C();\nreturn c instanceof Error\n  && c instanceof C\n  && Object.prototype.toString.call(c) === \"[object Error]\";"
            }, Subtest { name : "Map is subclassable", exec :
            "var key = {};\nclass M extends Map {}\nvar map = new M();\n\nmap.set(key, 123);\n\nreturn map instanceof M && map.has(key) && map.get(key) === 123;"
            }, Subtest { name : "Set is subclassable", exec :
